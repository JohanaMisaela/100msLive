...
export type eventData = browserData | errorData | exceptionData | consoleData | xhrCallData | navigationData | networkConnectionData | WebSocketData | httpRequestRespData | zipyLogMessageData | zipyLogExceptionData | zipyLogErrorData;
